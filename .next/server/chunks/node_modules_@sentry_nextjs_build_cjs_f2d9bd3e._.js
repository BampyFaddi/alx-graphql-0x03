 ...
 */ function isTurbopackDefaultForVersion(version) {
    if (!version) {
        return false;
    }
    const { major, minor, prerelease } = core.parseSemver(version);
 ...
 */ function detectActiveBundler(nextJsVersion) {
    if (("TURBOPACK compile-time value", true) || process.argv.includes('--turbo')) {
        return 'turbopack';
    }
...
exports.isTurbopackDefaultForVersion = isTurbopackDefaultForVersion;
...
function getFinalConfigObject(incomingUserNextConfigObject, userSentryOptions) {
    ...
    const activeBundler = util.detectActiveBundler(nextJsVersion);
...
//# sourceMappingURL=node_modules_%40sentry_nextjs_build_cjs_f2d9bd3e._.js.map